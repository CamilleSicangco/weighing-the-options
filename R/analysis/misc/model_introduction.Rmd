...
# Preliminary test of stomatal model accounting for thermal cost
...
plot(P, VC, type = 'l', 
     ylab = "Proportion of conductivity", xlab = "Leaf water potential (-MPa)")
...
```{r physio, fig.show="hold", out.width="50%"}
...
```{r cost-gain}
hydraulic_cst = hydraulic_cost(P = P, b = b, c = c, T_air = T_air, kmax_25 = kmax_25)
thermal_cst = thermal_cost(P = P, b = b, c = c, kmax_25 = kmax_25, T_air = T_air, RH = RH, Tcrit = Tcrit, T50 = T50)
carbon_gain = C_gain(P = P, b = b, c = c, kmax_25 = kmax_25, T_air = T_air, RH = RH)
...
plot(P, hydraulic_cst, type = 'l', col = 'blue', 
     ylab = "HC, TC, CG", xlab = "Leaf water potential (-MPa)", xlim = c(0, Pcrit), lwd = 2)
lines(P, thermal_cst, type = 'l', col = 'orange', lty = 2, lwd = 2)
lines(P, carbon_gain, type = 'l', col = 'black', lty = 3, lwd = 2)
...
{plot(P, CG_minus_HC, type = "l", col = "blue", 
      ...
      lwd = 2, xlim = c(0, Pcrit))
lines(P, CG_minus_bothC, type = "l", col = "orange", lty = 2, 
      lwd = 2)
