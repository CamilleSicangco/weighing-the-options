...
# Load A-Ci data from Dushan's compilation
ACi_params = 
  read.csv("https://bitbucket.org/Kumarathunge/aci-tglob/raw/master/Data/PPC-TGlob_V1.0.csv") %>% 
...
# Plot Jmax, Vcmax-T curves by chamber
...
# Combine fits into one dataframe and average values across the different chambers
